		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<div class="box-title">新增BoAttachUrl</div>
				</div>
				<div class="box-body">
					<form action="${basePath }/boAttachUrl/add.json" method="post" class="form-horizontal">
						<c:if test="${not empty error}">
 						...
 						<div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                        	<input type="text" class="form-control" name="attachUrl">
	                        </div>
	                    </div>
 						<div class="form-group">
							<label class="col-sm-2 control-label">AttachStatus</label>
	                        <div class="col-sm-10">
	                        	<input type="text" class="form-control" name="attachStatus">
	                        </div>
	                    </div>
 						<div class="form-group">
							<label class="col-sm-2 control-label">AttachEmail</label>
	                        <div class="col-sm-10">
	                        	<input type="text" class="form-control" name="attachEmail">
	                        </div>
	                    </div>
