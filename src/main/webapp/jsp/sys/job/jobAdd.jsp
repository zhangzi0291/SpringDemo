	...
	<section class="content">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
					<form action="${basePath }/job/add.json" method="post" class="form-horizontal">
						...
						<div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                        	<input type="text" class="form-control" name="cronExpression" placeholder="http://www.pppet.net/">
	                        </div>
	                    </div>
						<div class="form-group">
						...
						<div class="form-group">
	                        ...
	                        <div class="col-sm-10">
	                        	<textarea rows="3" class="form-control"  name="jobDesc" ></textarea>
	                        </div>
	                    </div>
