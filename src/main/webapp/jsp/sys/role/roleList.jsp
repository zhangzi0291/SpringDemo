...
<div id="toolbar">
	<form class="form-inline" role="form">
		<div class="form-group">
			<label for="roleName" >角色名称：</label><input id="roleName" class="form-control" />
		</div>
		<div class="form-group">
...
function initEvent(){
	...
	$("#edit").on("click",function(){
		...
		if(row[0].roleId==undefined){
			layer.msg("跳转错误")
			return;
		}
		jumpPage({
			method:"POST",	
			url:basePath+"/role/edit.html",
			roleId:row[0].roleId
		})
	})
